...
# Username do admin para link de contato (sem @)
ADMIN_USERNAME = os.getenv("ADMIN_USERNAME", "caioadmin")

# Configuração do Ciclo de Produção (dia inicial do ciclo)
CICLO_DIA_INICIO = int(os.getenv("CICLO_DIA_INICIO", "16"))
CICLO_DIAS_TURBO = int(os.getenv("CICLO_DIAS_TURBO", "24"))
